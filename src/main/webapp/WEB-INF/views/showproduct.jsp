...
<div class="container" id="product-section">
  ...
  <div class="row">
   <div class="col-md-5">
<img src = "<c:url value ='/resources/${product.id}.jpg'/>" height="200" width="200"/></a><br>
...
<div class="row add-to-cart">
 ...
 <div class="col-md-9">
  ...
  -->   <a href="${session.getContextPath()}/CloudWaiters/resources/${product.id}"><!-- add to cart --></a></div>
</div><!-- end row -->
...
<a href="${session.getContextPath()}/CloudWaiters/order/${product.id}" class="btn btn-warning btn-lg">
...
<%-- <img src="resources/${p.id}.jpg" height="150" width="150"/>
${p.id}--%>
</body>
</html>